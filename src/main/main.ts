...
import { ComponentSchemaService } from './services/ComponentSchemaService'
import { TailwindService } from './services/TailwindService'
...
class NestStudioApp {
    ...
    private codeGenerationService: CodeGenerationService | null = null
    ...
    constructor() {
        ...
        this.componentSchemaService = new ComponentSchemaService()
    ...
    private setupIPC() {
        ...
        ipcMain.handle('codegen:parseFile', async (_, filePath) => {
            try {
        ...
        ipcMain.handle('codegen:generateJSX', async (_, nodes) => {
            try {
                if (!this.codeGenerationService) {
                    return { success: false, error: 'Code generation service not initialized' }
                }
        ...
        ipcMain.handle('codegen:createComponentFile', async (_, componentName, content, directory) => {
            try {
                if (!this.codeGenerationService) {
                    return { success: false, error: 'Code generation service not initialized' }
                }
        ...
        ipcMain.handle('sync:start', async (_, projectPath) => {
            try {
                this.syncService = new SyncService(projectPath)
        ...
        ipcMain.handle('sync:addComponent', async (_, component, targetFile) => {
            try {
                if (!this.syncService) {
        ...
        ipcMain.handle('sync:updateComponent', async (_, componentId, updates) => {
            try {
                if (!this.syncService) {
                    return { success: false, error: 'Sync service not initialized' }
                }
        ...
        ipcMain.handle('sync:removeComponent', async (_, componentId) => {
            try {
                if (!this.syncService) {
                    return { success: false, error: 'Sync service not initialized' }
                }
        ...
        ipcMain.handle('sync:getComponents', async () => {
            try {
                if (!this.syncService) {
                    return { success: false, error: 'Sync service not initialized' }
                }
        ...
        ipcMain.handle('sync:getProjectState', async () => {
            try {
                if (!this.syncService) {
                    return { success: false, error: 'Sync service not initialized' }
                }
        ...
        ipcMain.handle('schema:getSchema', async (_, componentName) => {
            try {
        ...
        ipcMain.handle('schema:getAllSchemas', async () => {
            try {
        ...
        ipcMain.handle('schema:getSchemasByCategory', async (_, category) => {
            try {
        ...
        ipcMain.handle('schema:validateProp', async (_, propSchema, value) => {
            try {
        ...
        ipcMain.handle('schema:getDefaultProps', async (_, componentName) => {
            try {
        ...
        ipcMain.handle('tailwind:getAllClasses', async () => {
            try {
        ...
        ipcMain.handle('tailwind:getClassesByCategory', async (_, category) => {
            try {
        ...
        ipcMain.handle('tailwind:getCategories', async () => {
            try {
        ...
        ipcMain.handle('tailwind:searchClasses', async (_, query, limit) => {
            try {
        ...
        ipcMain.handle('tailwind:validateClass', async (_, className) => {
            try {
        ...
        ipcMain.handle('tailwind:validateClassString', async (_, classString) => {
            try {
        ...
        ipcMain.handle('tailwind:getResponsiveVariants', async (_, className) => {
            try {
        ...
        ipcMain.handle('tailwind:getStateVariants', async (_, className) => {
            try {
